drop function public.get_closet_products(uuid);
drop function public.get_digbox_products(uuid);
...
returns table (
  ...
  target_gender text,
  human_target_gender text,
  style_tags jsonb,
  style_attributes jsonb,
  human_style_tags jsonb,
  human_style_attributes jsonb,
