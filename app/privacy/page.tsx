    ...
    >
        ...
        <LegalTable
          ...
          rows={[
            ...
            [
              ...
              "브라우저 익명 식별자 또는 서버에서 해시한 회원 분석 식별자, 페이지·기능 이벤트, 브라우저·기기·IP 및 대략적 지역 정보. 이메일·이용자명·입력 내용은 제품 분석에 전송하지 않으며 미국 클라우드에서 처리됩니다.",
            ],
            [
              "Google LLC",
      ...
      <LegalSection id="cookies" title="8. 쿠키, 로컬 스토리지 및 행태정보">
        <p>
          ...
          PostHog는 페이지 조회와 클릭·기능 이용 이벤트를 수집하고 익명 식별자를 브라우저에 저장할 수 있습니다. 로그인하면 서버가 회원 계정 식별자를
          복원할 수 없도록 해시한 분석 식별자로 익명 행동을 연결할 수 있습니다. Vercel Web
