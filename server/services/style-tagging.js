...
const STYLE_ATTRIBUTE_OPTIONS = {
  ...
  top_type: ["unknown", "sleeveless", "t_shirt", "shirt", "pique", "knit", "sweatshirt", "hoodie"],
  top_silhouette: ["unknown", "slim", "regular", "relaxed", "oversized", "boxy"],
  outer_type: ["unknown", "jacket", "blazer", "coat", "padding", "vest", "windbreaker"],
  outer_silhouette: ["unknown", "slim", "regular", "relaxed", "oversized", "boxy"],
...
중요 규칙:
1. 먼저 bottom_silhouette, top_type, top_silhouette, outer_type, outer_silhouette, top_length, material, color, wash_texture, details을 분석하세요. top_type은 민소매, 티셔츠, 셔츠, 피케, 니트, 스웨트셔츠, 후디를 구분하는 값이고, outer_type은 재킷, 블레이저, 코트, 패딩, 베스트, 바람막이를 구분하는 값입니다. 모든 속성은 복수 선택 배열이며, 이미지로 판단할 수 없으면 빈 배열을 사용하세요.
