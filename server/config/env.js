...
export const SUPABASE_PRODUCTS_TABLE = (process.env.SUPABASE_PRODUCTS_TABLE || "products").trim();
export const SUPABASE_STORAGE_BUCKET = (process.env.SUPABASE_STORAGE_BUCKET || "product-assets").trim();
...
export const PRODUCT_METADATA_MAX_SIZE_CHART_PAGES = Number(
  process.env.PRODUCT_METADATA_MAX_SIZE_CHART_PAGES || 3
);
export const PRODUCT_METADATA_MIN_SIZE_CHART_IMAGE_BYTES = Number(
  process.env.PRODUCT_METADATA_MIN_SIZE_CHART_IMAGE_BYTES || 12 * 1024
);
export const PRODUCT_METADATA_MIN_SIZE_CHART_IMAGE_WIDTH = Number(
  process.env.PRODUCT_METADATA_MIN_SIZE_CHART_IMAGE_WIDTH || 320
);
export const PRODUCT_METADATA_MIN_SIZE_CHART_IMAGE_HEIGHT = Number(
  process.env.PRODUCT_METADATA_MIN_SIZE_CHART_IMAGE_HEIGHT || 120
);
export const PRODUCT_METADATA_MAX_SIZE_CHART_IMAGE_ASPECT_RATIO = Number(
  process.env.PRODUCT_METADATA_MAX_SIZE_CHART_IMAGE_ASPECT_RATIO || 6
);
export const PRODUCT_METADATA_MIN_PRODUCT_IMAGE_BYTES = Number(
  process.env.PRODUCT_METADATA_MIN_PRODUCT_IMAGE_BYTES || 8 * 1024
);
export const PRODUCT_METADATA_MIN_PRODUCT_IMAGE_WIDTH = Number(
  process.env.PRODUCT_METADATA_MIN_PRODUCT_IMAGE_WIDTH || 240
);
export const PRODUCT_METADATA_MIN_PRODUCT_IMAGE_HEIGHT = Number(
  process.env.PRODUCT_METADATA_MIN_PRODUCT_IMAGE_HEIGHT || 240
);
export const PRODUCT_METADATA_MAX_PRODUCT_IMAGE_ASPECT_RATIO = Number(
  process.env.PRODUCT_METADATA_MAX_PRODUCT_IMAGE_ASPECT_RATIO || 3.2
);
export const PRODUCT_METADATA_MAX_GEMINI_IMAGE_TRIES = Number(
...
export const PRODUCT_METADATA_GEMINI_IMAGE_RERANK_LIMIT = Number(
  process.env.PRODUCT_METADATA_GEMINI_IMAGE_RERANK_LIMIT || 10
);
export const PRODUCT_METADATA_GEMINI_IMAGE_SCAN_LIMIT = Number(
  process.env.PRODUCT_METADATA_GEMINI_IMAGE_SCAN_LIMIT || 12
);
export const PRODUCT_METADATA_SEARCH_RESULT_LIMIT = Number(
  process.env.PRODUCT_METADATA_SEARCH_RESULT_LIMIT || 6
);
export const PRODUCT_METADATA_SEARCH_FETCH_TIMEOUT_MS = Number(
  process.env.PRODUCT_METADATA_SEARCH_FETCH_TIMEOUT_MS || 10000
);
export const PRODUCT_METADATA_BROWSER_TIMEOUT_MS = Number(
  process.env.PRODUCT_METADATA_BROWSER_TIMEOUT_MS || 12000
);
