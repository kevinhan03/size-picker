...
export function CollectionSearchField({
  ...
  return (
    <div className={`collection-search-field ${spacing === "compact" ? "mb-3" : "mb-5"}`}>
      <div className="flex h-11 w-full items-center gap-2 rounded-xl border border-white/[0.1] bg-white/[0.045] px-3.5 transition-[background-color,border-color,box-shadow] duration-150 focus-within:border-orange-400/60 focus-within:bg-white/[0.07] focus-within:ring-2 focus-within:ring-orange-500/10">
