...
export type ProductCategoryCode = "Top" | "Outer" | "Bottom" | "DressSkirt" | "Shoes" | "Bag" | "JewelryWatch" | "FashionAccessory";
export type ProductSubcategory = string;
export const PRODUCT_CATEGORIES = PRODUCT_CATEGORY_REGISTRY as ReadonlyArray<{ code: ProductCategoryCode; label: string; subcategories: readonly ProductSubcategory[] }>;
