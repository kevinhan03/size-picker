export const PRODUCT_CATEGORY_REGISTRY = [
  { code: "Top", label: "상의", subcategories: ["긴소매 티셔츠", "맨투맨·스웨트", "셔츠·블라우스", "후드 티셔츠", "반소매 티셔츠", "피케·카라 티셔츠", "니트·스웨터", "민소매 티셔츠", "기타 상의"] },
  { code: "Outer", label: "아우터", subcategories: ["집업", "블루종·MA-1", "레더·라이더스 재킷", "수트·블레이저 재킷", "가디건", "코트·트렌치", "경량 패딩·패딩 베스트", "사파리·헌팅 재킷", "트러커 재킷", "스타디움 재킷", "나일론·코치 재킷", "트레이닝 재킷", "아노락 재킷", "플리스·뽀글이", "기타 아우터"] },
  ...
  { code: "Shoes", label: "신발", subcategories: ["스니커즈", "스포츠화", "구두", "부츠·워커", "샌들·슬리퍼", "러버슈즈", "패딩·퍼 신발"] },
